...
@kalla2022outside studies the effect of talking with an outpartisan, someone from a different party, on attitude toward the other parties. The subjects were randomly assigned into either the treatment group ($D_i = 1$), in which they were informed that the partner would be an outpartisan, or the control group ($D_i = 0$), in which they received no extra information. $S_i\in(1,0)$ indicates whether the subjects initiate the online conversation and finish the questionnaire. Always-responders in this study refer to those who will start the conversation regardless the partisanship of their partners.
